...
Route::get('san-pham',[SanphamController::class,'index'])->name('site.product'); // san pham
Route::get('chi-tiet-san-pham/{slug}',[SanphamController::class,'product_detail'])->name('site.product.detail'); // chi tiet san pham
Route::get('lien-he',[LienheController::class,'index'])->name('site.contact'); // lien he
