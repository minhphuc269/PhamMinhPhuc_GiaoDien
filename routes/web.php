...
Route::get('gioi_thieu', [BaiVietController::class, 'gioi_thieu'])->name('gioi_thieu');
Route::get('chinh_sach_mua_hang', [BaiVietController::class, 'chinh_sach_mua_hang'])->name('chinh_sach_mua_hang');
Route::get('chinh_sach_van_chuyen', [BaiVietController::class, 'chinh_sach_van_chuyen'])->name('chinh_sach_van_chuyen');
Route::get('chinh_sach_bao_hanh', [BaiVietController::class, 'chinh_sach_bao_hanh'])->name('chinh_sach_bao_hanh');
Route::get('chinh_sach_doi_tra', [BaiVietController::class, 'chinh_sach_doi_tra'])->name('chinh_sach_doi_tra');
