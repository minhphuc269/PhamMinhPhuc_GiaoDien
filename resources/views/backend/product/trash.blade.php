                    ...
                    <tbody>
                        @foreach ($list as $row)
                            <tr class="datarow">
                                ...
                                <td>{{ $row->id }}</td>
                                <td><img src="{{ asset('images/products/' . $row->image) }}" alt="{{ $row->image }}" style="width: 100px;"></td>
                                <td>{{ $row->name }}</td>
                                <td>{{ $row->slug }}</td>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.product.restore', $args) }}" class="btn btn-primary" style="width:40px; height: 40px;"><i class="fas fa-undo"></i></a>
                                    <a href="{{ route('admin.product.show', $args) }}" class="btn btn-info" style="width:40px; height: 40px;"><i class="fas fa-eye"></i></a>
