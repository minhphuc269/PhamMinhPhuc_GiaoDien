            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" id="name" class="form-control small-placeholder" placeholder="Nhập tên thương hiệu..." required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="slug" id="slug" class="form-control small-placeholder" placeholder="Nhập mô tả..." required>
                </div>
                <div class="form-group">
