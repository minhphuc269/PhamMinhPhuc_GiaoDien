    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand text-success logo h1 align-self-center" href="index.html">
                <img class="img-fluid" src="images/logo.png" alt="" style="width: 150px;">
            </a>
                    ...
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                <a href="product_detail.html">Watches</a>
                                <a href="product_detail.html">Shoes</a>
                                <a href="product_detail.html">Accessories</a>
                            </div>
                        </div>
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="images/banner_img_02.jpg" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="{{ asset('images/category_img_01.jpg') }}"
                        class="rounded-circle img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">Watches</h5>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="{{ asset('images/category_img_02.jpg') }}"
                        class="rounded-circle img-fluid border"></a>
                <h2 class="h5 text-center mt-3 mb-3">Shoes</h2>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="{{ asset('images/category_img_03.jpg') }}"
                        class="rounded-circle img-fluid border"></a>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="product_detail.html" class="h2 text-decoration-none text-dark">Gym Weight</a>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt in culpa qui officia
                                deserunt, consectetur adipisicing elit.
                            </p>
                            <p class="text-muted">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="product_detail.html" class="h2 text-decoration-none text-dark">Cloud Nike
                                Shoes</a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="product_detail.html" class="h2 text-decoration-none text-dark">Summer Addides
                                Shoes</a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="product_detail.html">
                            <img src="{{ asset('images/feature_prod_03.jpg') }}" class="card-img-top"
                                alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="{{ asset('images/feature_prod_01.jpg') }}" class="card-img-top"
                                alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="{{ asset('images/feature_prod_02.jpg') }}" class="card-img-top"
                                alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
            ...
            <div class="row">
                <div class="col-md-12 margin_top40">
                    <div class="row d_flex">
                        <div class="col-md-5">
                            <div class="news_img">
                                <figure><img src="{{ asset('images/brand_01.png') }} "></figure>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="news_text">
                ...
                <div class="col-md-12 margin_top40">
                    <div class="row d_flex">
                        <div class="col-md-5">
                            <div class="news_img">
                                <figure><img src="{{ asset('images/brand_02.png') }}"></figure>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="news_text">
                ...
                <div class="col-md-12 margin_top40">
                    <div class="row d_flex">
                        <div class="col-md-5">
                            <div class="news_img">
                                <figure><img src="{{ asset('images/brand_03.png') }}"></figure>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="news_text">
